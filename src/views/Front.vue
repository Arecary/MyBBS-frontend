  ...
  <div>
    ...
    <div class="front-header">
      <div class="front-header-left">
        ...
        <div class="title">MyBBS</div>
      </div>
      <div class="front-header-center">
        <div class="front-header-nav">
          <el-menu :default-active="$route.path" mode="horizontal" router>
						<el-menu-item index="/front/home">Front page</el-menu-item>
<!--						<el-menu-item index="/front/activity">Activity</el-menu-item>-->
						<el-menu-item index="/front/person">Home</el-menu-item>
          </el-menu>
        </div>
      </div>
      <div>
        <el-input style="width: 260px; margin-right: 10px" placeholder="Please input keyword to search" v-model="title" clearable></el-input>
