  ...
  <div class="manager-container">
    ...
    <div class="manager-header">
      <div class="manager-header-left">
        ...
        <div class="title">Backend system</div>
      </div>

      <div class="manager-header-center">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          <el-breadcrumb-item :to="{ path: '/' }">Home</el-breadcrumb-item>
          <!--  按照index.js里路由的meta name显示  -->
      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'user']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="info">
            <template slot="title">
              <i class="el-icon-menu"></i><span>Content manage</span>
            </template>
...
<!--            <el-menu-item index="/activity">Activity</el-menu-item>-->
          ...
          <el-submenu index="user">
            <template slot="title">
              <i class="el-icon-menu"></i><span>Account manage</span>
            </template>
...
export default {
  ...
  created() {
    if (!this.user.id || this.user.role !== 'ADMIN'){ // 防止修改网址强行跳转后台页面
