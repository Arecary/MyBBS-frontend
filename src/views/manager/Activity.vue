<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter activity name to search" style="width: 300px" v-model="name"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column label="Activity preview" width="140">
          <template v-slot="scope">
    ...
    <el-dialog title="Info" :visible.sync="fromVisible" width="50%" :close-on-click-modal="false" destroy-on-close>
    ...
    <el-dialog title="Activity info" :visible.sync="fromVisible1" width="40%" :close-on-click-modal="false" destroy-on-close>
      <div class="w-e-text">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        descr: [
          {required: true, message: 'Please enter the contents', trigger: 'blur'},
        ],
        start: [
          {required: true, message: 'Please enter start time', trigger: 'blur'},
        ],
        end: [
        ...
        host: [
          {required: true, message: 'Please enter organizer', trigger: 'blur'},
        ],
      },
      ids: [],
      editor: null,
  ...
  methods: {
    ...
    delBatch() {   // 批量删除
      if (!this.ids.length) {
        this.$message.warning('Please select at least one activity')
        return
      }
    ...
    setRichText(content) {
      this.$nextTick(() => {
        ...
        this.editor.txt.html(content)  // 创建
      })
    },
  }
}
