<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter category name to search" style="width: 300px" v-model="name"></el-input>
...
export default {
  ...
  methods: {
    ...
    del(id) {   // 单个删除
      this.$confirm('Sure to delete?', 'confirm', {type: "warning"}).then(response => {
    ...
    delBatch() {   // 批量删除
      ...
      this.$confirm('Are you sure you want to delete these data in batches?', 'confirm', {type: "warning"}).then(response => {
