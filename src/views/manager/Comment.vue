<template>
  <div>
    <div class="search">
      <el-input placeholder="Please enter username to search" style="width: 300px" v-model="userName"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" strip @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="pid" label="Parent id (comment)"></el-table-column>
        <el-table-column prop="rootId" label="Root id (comment)"></el-table-column>
        <el-table-column prop="time" label="Created date"></el-table-column>
        <el-table-column prop="fid" label="Foreign id (blog)"></el-table-column>
    ...
    <el-dialog title="Info" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        ...
        <el-form-item label="Pid" prop="pid">
          <el-input v-model="form.pid" placeholder="Pid"></el-input>
        </el-form-item>
        <el-form-item label="RootId" prop="rootId">
          <el-input v-model="form.rootId" placeholder="RootId"></el-input>
        </el-form-item>
        <el-form-item label="Time" prop="time">
          <el-input v-model="form.time" placeholder="Time"></el-input>
        </el-form-item>
        <el-form-item label="Fid" prop="fid">
          <el-input v-model="form.fid" placeholder="Fid"></el-input>
        </el-form-item>
