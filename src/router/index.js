...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'blog', name: 'Blog', meta: { name: 'Blog' }, component: () => import('../views/manager/Blog') },
      { path: 'activity', name: 'Activity', meta: { name: 'Activity' }, component: () => import('../views/manager/Activity') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'blogDetail', name: 'BlogDetail', meta: { name: 'BlogDetail' }, component: () => import('../views/front/BlogDetail') },
      { path: 'search', name: 'Search', meta: { name: 'Search' }, component: () => import('../views/front/Search') },
      { path: 'newBlog', name: 'NewBlog', meta: { name: 'NewBlog' }, component: () => import('../views/front/NewBlog') },
    ]
  },
